...
from ..models.market_order_transaction_position_fill import MarketOrderTransactionPositionFill
from ..models.market_order_transaction_reason import MarketOrderTransactionReason
from ..models.market_order_transaction_time_in_force import MarketOrderTransactionTimeInForce
from ..models.market_order_transaction_type import MarketOrderTransactionType
...
class MarketOrderTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, MarketOrderTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = MarketOrderTransactionType(_type)
        ...
        time_in_force: Union[Unset, MarketOrderTransactionTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = MarketOrderTransactionTimeInForce(_time_in_force)

        price_bound = d.pop("priceBound", UNSET)

        _position_fill = d.pop("positionFill", UNSET)
        position_fill: Union[Unset, MarketOrderTransactionPositionFill]
        if isinstance(_position_fill, Unset):
            position_fill = UNSET
        else:
            position_fill = MarketOrderTransactionPositionFill(_position_fill)
        ...
        reason: Union[Unset, MarketOrderTransactionReason]
        if isinstance(_reason, Unset):
            reason = UNSET
        else:
            reason = MarketOrderTransactionReason(_reason)
