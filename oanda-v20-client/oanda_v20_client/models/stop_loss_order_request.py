...
from ..models.stop_loss_order_request_time_in_force import StopLossOrderRequestTimeInForce
from ..models.stop_loss_order_request_trigger_condition import StopLossOrderRequestTriggerCondition
...
class StopLossOrderRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = StopLossOrderRequestType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = StopLossOrderRequestTimeInForce(_time_in_force)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = StopLossOrderRequestTriggerCondition(_trigger_condition)
