...
from ..models.trade_client_extensions_modify_reject_transaction_reject_reason import (
    TradeClientExtensionsModifyRejectTransactionRejectReason,
)
from ..models.trade_client_extensions_modify_reject_transaction_type import (
...
class TradeClientExtensionsModifyRejectTransaction:
    ...
    reject_reason: Union[Unset, TradeClientExtensionsModifyRejectTransactionRejectReason] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.trade_client_extensions_modify, Unset):
            trade_client_extensions_modify = self.trade_client_extensions_modify.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, TradeClientExtensionsModifyRejectTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = TradeClientExtensionsModifyRejectTransactionType(_type)
        ...
        if isinstance(_trade_client_extensions_modify, Unset):
            ...
            trade_client_extensions_modify = ClientExtensions.from_dict(_trade_client_extensions_modify)

        _reject_reason = d.pop("rejectReason", UNSET)
        reject_reason: Union[Unset, TradeClientExtensionsModifyRejectTransactionRejectReason]
        if isinstance(_reject_reason, Unset):
            reject_reason = UNSET
        else:
            reject_reason = TradeClientExtensionsModifyRejectTransactionRejectReason(_reject_reason)
        ...
        trade_client_extensions_modify_reject_transaction.additional_properties = d
