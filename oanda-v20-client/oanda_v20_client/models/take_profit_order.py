...
class TakeProfitOrder:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_state, Unset):
            ...
            state = TakeProfitOrderState(_state)
        ...
        if isinstance(_type, Unset):
            ...
            type = TakeProfitOrderType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = TakeProfitOrderTimeInForce(_time_in_force)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = TakeProfitOrderTriggerCondition(_trigger_condition)
