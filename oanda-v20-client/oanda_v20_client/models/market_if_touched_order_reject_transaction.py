...
from ..models.market_if_touched_order_reject_transaction_position_fill import (
    MarketIfTouchedOrderRejectTransactionPositionFill,
)
from ..models.market_if_touched_order_reject_transaction_reason import MarketIfTouchedOrderRejectTransactionReason
from ..models.market_if_touched_order_reject_transaction_reject_reason import (
    MarketIfTouchedOrderRejectTransactionRejectReason,
)
from ..models.market_if_touched_order_reject_transaction_time_in_force import (
    MarketIfTouchedOrderRejectTransactionTimeInForce,
)
from ..models.market_if_touched_order_reject_transaction_trigger_condition import (
    MarketIfTouchedOrderRejectTransactionTriggerCondition,
)
from ..models.market_if_touched_order_reject_transaction_type import MarketIfTouchedOrderRejectTransactionType
...
class MarketIfTouchedOrderRejectTransaction:
    ...
    time_in_force: Union[Unset, MarketIfTouchedOrderRejectTransactionTimeInForce] = UNSET
    gtd_time: Union[Unset, str] = UNSET
    position_fill: Union[Unset, MarketIfTouchedOrderRejectTransactionPositionFill] = UNSET
    trigger_condition: Union[Unset, MarketIfTouchedOrderRejectTransactionTriggerCondition] = UNSET
    ...
    reject_reason: Union[Unset, MarketIfTouchedOrderRejectTransactionRejectReason] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, MarketIfTouchedOrderRejectTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = MarketIfTouchedOrderRejectTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = MarketIfTouchedOrderRejectTransactionTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = MarketIfTouchedOrderRejectTransactionPositionFill(_position_fill)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, MarketIfTouchedOrderRejectTransactionTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = MarketIfTouchedOrderRejectTransactionTriggerCondition(_trigger_condition)

        _reason = d.pop("reason", UNSET)
        reason: Union[Unset, MarketIfTouchedOrderRejectTransactionReason]
        if isinstance(_reason, Unset):
            reason = UNSET
        else:
            reason = MarketIfTouchedOrderRejectTransactionReason(_reason)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = MarketIfTouchedOrderRejectTransactionRejectReason(_reject_reason)
