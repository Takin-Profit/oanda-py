...
from ..models.client_configure_transaction_type import ClientConfigureTransactionType
...
class ClientConfigureTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, ClientConfigureTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = ClientConfigureTransactionType(_type)
