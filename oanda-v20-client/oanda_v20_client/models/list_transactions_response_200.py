...
from ..models.list_transactions_response_200_type_item import ListTransactionsResponse200TypeItem
...
class ListTransactionsResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for type_item_data in _type or []:
            type_item = ListTransactionsResponse200TypeItem(type_item_data)
