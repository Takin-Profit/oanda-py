...
from ..models.take_profit_order_transaction_reason import TakeProfitOrderTransactionReason
from ..models.take_profit_order_transaction_time_in_force import TakeProfitOrderTransactionTimeInForce
from ..models.take_profit_order_transaction_trigger_condition import TakeProfitOrderTransactionTriggerCondition
from ..models.take_profit_order_transaction_type import TakeProfitOrderTransactionType
...
class TakeProfitOrderTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, TakeProfitOrderTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = TakeProfitOrderTransactionType(_type)
        ...
        time_in_force: Union[Unset, TakeProfitOrderTransactionTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = TakeProfitOrderTransactionTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, TakeProfitOrderTransactionTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = TakeProfitOrderTransactionTriggerCondition(_trigger_condition)

        _reason = d.pop("reason", UNSET)
        reason: Union[Unset, TakeProfitOrderTransactionReason]
        if isinstance(_reason, Unset):
            reason = UNSET
        else:
            reason = TakeProfitOrderTransactionReason(_reason)
