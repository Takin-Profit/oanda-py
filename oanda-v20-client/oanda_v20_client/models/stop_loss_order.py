...
from ..models.stop_loss_order_state import StopLossOrderState
from ..models.stop_loss_order_time_in_force import StopLossOrderTimeInForce
from ..models.stop_loss_order_trigger_condition import StopLossOrderTriggerCondition
from ..models.stop_loss_order_type import StopLossOrderType
...
class StopLossOrder:
    ...
    state: Union[Unset, StopLossOrderState] = UNSET
    client_extensions: Union[Unset, "ClientExtensions"] = UNSET
    type: Union[Unset, StopLossOrderType] = UNSET
    ...
    time_in_force: Union[Unset, StopLossOrderTimeInForce] = UNSET
    gtd_time: Union[Unset, str] = UNSET
    trigger_condition: Union[Unset, StopLossOrderTriggerCondition] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        state: Union[Unset, StopLossOrderState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = StopLossOrderState(_state)
        ...
        type: Union[Unset, StopLossOrderType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = StopLossOrderType(_type)
        ...
        time_in_force: Union[Unset, StopLossOrderTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = StopLossOrderTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, StopLossOrderTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = StopLossOrderTriggerCondition(_trigger_condition)
