...
class SetOrderClientExtensionsResponse200:
    ...
    order_client_extensions_modify_transaction: Union[Unset, "OrderClientExtensionsModifyTransaction"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.order_client_extensions_modify_transaction, Unset):
            order_client_extensions_modify_transaction = self.order_client_extensions_modify_transaction.to_dict()
        ...
        if order_client_extensions_modify_transaction is not UNSET:
            field_dict["orderClientExtensionsModifyTransaction"] = order_client_extensions_modify_transaction
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _order_client_extensions_modify_transaction = d.pop("orderClientExtensionsModifyTransaction", UNSET)
        order_client_extensions_modify_transaction: Union[Unset, OrderClientExtensionsModifyTransaction]
        if isinstance(_order_client_extensions_modify_transaction, Unset):
            order_client_extensions_modify_transaction = UNSET
        else:
            order_client_extensions_modify_transaction = OrderClientExtensionsModifyTransaction.from_dict(
