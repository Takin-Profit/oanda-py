...
from ..models.stop_order_request_position_fill import StopOrderRequestPositionFill
from ..models.stop_order_request_time_in_force import StopOrderRequestTimeInForce
from ..models.stop_order_request_trigger_condition import StopOrderRequestTriggerCondition
from ..models.stop_order_request_type import StopOrderRequestType
...
class StopOrderRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, StopOrderRequestType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = StopOrderRequestType(_type)
        ...
        time_in_force: Union[Unset, StopOrderRequestTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = StopOrderRequestTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _position_fill = d.pop("positionFill", UNSET)
        position_fill: Union[Unset, StopOrderRequestPositionFill]
        if isinstance(_position_fill, Unset):
            position_fill = UNSET
        else:
            position_fill = StopOrderRequestPositionFill(_position_fill)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, StopOrderRequestTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = StopOrderRequestTriggerCondition(_trigger_condition)
