...
from ..models.account_guaranteed_stop_loss_order_mode import AccountGuaranteedStopLossOrderMode
...
class Account:
    ...
    guaranteed_stop_loss_order_mode: Union[Unset, AccountGuaranteedStopLossOrderMode] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        guaranteed_stop_loss_order_mode: Union[Unset, AccountGuaranteedStopLossOrderMode]
        if isinstance(_guaranteed_stop_loss_order_mode, Unset):
            guaranteed_stop_loss_order_mode = UNSET
        else:
            guaranteed_stop_loss_order_mode = AccountGuaranteedStopLossOrderMode(_guaranteed_stop_loss_order_mode)
