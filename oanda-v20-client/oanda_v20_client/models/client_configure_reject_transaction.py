...
from ..models.client_configure_reject_transaction_reject_reason import ClientConfigureRejectTransactionRejectReason
from ..models.client_configure_reject_transaction_type import ClientConfigureRejectTransactionType
...
class ClientConfigureRejectTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = ClientConfigureRejectTransactionType(_type)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = ClientConfigureRejectTransactionRejectReason(_reject_reason)
