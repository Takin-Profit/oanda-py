...
from ..models.market_if_touched_order_transaction_position_fill import MarketIfTouchedOrderTransactionPositionFill
from ..models.market_if_touched_order_transaction_reason import MarketIfTouchedOrderTransactionReason
from ..models.market_if_touched_order_transaction_time_in_force import MarketIfTouchedOrderTransactionTimeInForce
from ..models.market_if_touched_order_transaction_trigger_condition import (
    MarketIfTouchedOrderTransactionTriggerCondition,
)
from ..models.market_if_touched_order_transaction_type import MarketIfTouchedOrderTransactionType
...
class MarketIfTouchedOrderTransaction:
    ...
    trigger_condition: Union[Unset, MarketIfTouchedOrderTransactionTriggerCondition] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = MarketIfTouchedOrderTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = MarketIfTouchedOrderTransactionTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = MarketIfTouchedOrderTransactionPositionFill(_position_fill)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = MarketIfTouchedOrderTransactionTriggerCondition(_trigger_condition)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = MarketIfTouchedOrderTransactionReason(_reason)
