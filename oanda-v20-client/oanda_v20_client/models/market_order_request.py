...
class MarketOrderRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = MarketOrderRequestType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = MarketOrderRequestTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = MarketOrderRequestPositionFill(_position_fill)
