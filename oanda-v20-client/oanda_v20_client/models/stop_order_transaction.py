...
from ..models.stop_order_transaction_position_fill import StopOrderTransactionPositionFill
from ..models.stop_order_transaction_reason import StopOrderTransactionReason
from ..models.stop_order_transaction_time_in_force import StopOrderTransactionTimeInForce
from ..models.stop_order_transaction_trigger_condition import StopOrderTransactionTriggerCondition
from ..models.stop_order_transaction_type import StopOrderTransactionType
...
T = TypeVar("T", bound="StopOrderTransaction")
...
class StopOrderTransaction:
    ...
    Attributes:
        ...
        type (Union[Unset, StopOrderTransactionType]): The Type of the Transaction. Always set to "STOP_ORDER" in a
        ...
        price_bound (Union[Unset, str]): The worst market price that may be used to fill this Stop Order. If the market
            ...
            filled.
        time_in_force (Union[Unset, StopOrderTransactionTimeInForce]): The time-in-force requested for the Stop Order.
        gtd_time (Union[Unset, str]): The date/time when the Stop Order will be cancelled if its timeInForce is "GTD".
        position_fill (Union[Unset, StopOrderTransactionPositionFill]): Specification of how Positions in the Account
            are modified when the Order is filled.
        trigger_condition (Union[Unset, StopOrderTransactionTriggerCondition]): Specification of which price component
        ...
        reason (Union[Unset, StopOrderTransactionReason]): The reason that the Stop Order was initiated
    ...
    type: Union[Unset, StopOrderTransactionType] = UNSET
    instrument: Union[Unset, str] = UNSET
    units: Union[Unset, str] = UNSET
    price: Union[Unset, str] = UNSET
    price_bound: Union[Unset, str] = UNSET
    time_in_force: Union[Unset, StopOrderTransactionTimeInForce] = UNSET
    gtd_time: Union[Unset, str] = UNSET
    position_fill: Union[Unset, StopOrderTransactionPositionFill] = UNSET
    trigger_condition: Union[Unset, StopOrderTransactionTriggerCondition] = UNSET
    reason: Union[Unset, StopOrderTransactionReason] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.position_fill, Unset):
            position_fill = self.position_fill.value
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, StopOrderTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = StopOrderTransactionType(_type)
        ...
        time_in_force: Union[Unset, StopOrderTransactionTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = StopOrderTransactionTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _position_fill = d.pop("positionFill", UNSET)
        position_fill: Union[Unset, StopOrderTransactionPositionFill]
        if isinstance(_position_fill, Unset):
            position_fill = UNSET
        else:
            position_fill = StopOrderTransactionPositionFill(_position_fill)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, StopOrderTransactionTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = StopOrderTransactionTriggerCondition(_trigger_condition)

        _reason = d.pop("reason", UNSET)
        reason: Union[Unset, StopOrderTransactionReason]
        if isinstance(_reason, Unset):
            reason = UNSET
        else:
            reason = StopOrderTransactionReason(_reason)
        ...
        if isinstance(_trailing_stop_loss_on_fill, Unset):
            ...
            trailing_stop_loss_on_fill = TrailingStopLossDetails.from_dict(_trailing_stop_loss_on_fill)
        ...
        stop_order_transaction.additional_properties = d
        return stop_order_transaction
