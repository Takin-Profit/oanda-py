...
from ..models.stop_loss_order_transaction_reason import StopLossOrderTransactionReason
from ..models.stop_loss_order_transaction_time_in_force import StopLossOrderTransactionTimeInForce
from ..models.stop_loss_order_transaction_trigger_condition import StopLossOrderTransactionTriggerCondition
from ..models.stop_loss_order_transaction_type import StopLossOrderTransactionType
...
class StopLossOrderTransaction:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        guaranteed_execution_premium = self.guaranteed_execution_premium
        ...
        if guaranteed_execution_premium is not UNSET:
            field_dict["guaranteedExecutionPremium"] = guaranteed_execution_premium
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, StopLossOrderTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = StopLossOrderTransactionType(_type)
        ...
        time_in_force: Union[Unset, StopLossOrderTransactionTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = StopLossOrderTransactionTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, StopLossOrderTransactionTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = StopLossOrderTransactionTriggerCondition(_trigger_condition)

        guaranteed = d.pop("guaranteed", UNSET)

        guaranteed_execution_premium = d.pop("guaranteedExecutionPremium", UNSET)

        _reason = d.pop("reason", UNSET)
        reason: Union[Unset, StopLossOrderTransactionReason]
        if isinstance(_reason, Unset):
            reason = UNSET
        else:
            reason = StopLossOrderTransactionReason(_reason)
        ...
        stop_loss_order_transaction = cls(
            id=id,
            time=time,
            user_id=user_id,
        ...
        stop_loss_order_transaction.additional_properties = d
        return stop_loss_order_transaction
