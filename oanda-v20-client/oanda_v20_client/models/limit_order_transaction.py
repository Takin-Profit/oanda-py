...
from ..models.limit_order_transaction_position_fill import LimitOrderTransactionPositionFill
from ..models.limit_order_transaction_reason import LimitOrderTransactionReason
from ..models.limit_order_transaction_time_in_force import LimitOrderTransactionTimeInForce
from ..models.limit_order_transaction_trigger_condition import LimitOrderTransactionTriggerCondition
...
class LimitOrderTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = LimitOrderTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = LimitOrderTransactionTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = LimitOrderTransactionPositionFill(_position_fill)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = LimitOrderTransactionTriggerCondition(_trigger_condition)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = LimitOrderTransactionReason(_reason)
