...
from ..models.margin_call_extend_transaction_type import MarginCallExtendTransactionType
...
class MarginCallExtendTransaction:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if extension_number is not UNSET:
            field_dict["extensionNumber"] = extension_number
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, MarginCallExtendTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = MarginCallExtendTransactionType(_type)

        extension_number = d.pop("extensionNumber", UNSET)
