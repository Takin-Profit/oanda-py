...
from ..models.transfer_funds_transaction_funding_reason import TransferFundsTransactionFundingReason
...
class TransferFundsTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TransferFundsTransactionType(_type)
        ...
        if isinstance(_funding_reason, Unset):
            ...
            funding_reason = TransferFundsTransactionFundingReason(_funding_reason)
