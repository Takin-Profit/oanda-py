...
from ..models.trailing_stop_loss_order_time_in_force import TrailingStopLossOrderTimeInForce
from ..models.trailing_stop_loss_order_trigger_condition import TrailingStopLossOrderTriggerCondition
...
class TrailingStopLossOrder:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_state, Unset):
            ...
            state = TrailingStopLossOrderState(_state)
        ...
        if isinstance(_type, Unset):
            ...
            type = TrailingStopLossOrderType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = TrailingStopLossOrderTimeInForce(_time_in_force)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = TrailingStopLossOrderTriggerCondition(_trigger_condition)
