...
class ReplaceOrderResponse404:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        order_cancel_reject_transaction: Union[Unset, Transaction]
        if isinstance(_order_cancel_reject_transaction, Unset):
            order_cancel_reject_transaction = UNSET
        else:
            order_cancel_reject_transaction = Transaction.from_dict(_order_cancel_reject_transaction)
        ...
        replace_order_response_404 = cls(
        ...
        replace_order_response_404.additional_properties = d
        return replace_order_response_404
