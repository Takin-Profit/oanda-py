...
from ..models.take_profit_order_reject_transaction_reason import TakeProfitOrderRejectTransactionReason
from ..models.take_profit_order_reject_transaction_reject_reason import TakeProfitOrderRejectTransactionRejectReason
from ..models.take_profit_order_reject_transaction_time_in_force import TakeProfitOrderRejectTransactionTimeInForce
...
from ..models.take_profit_order_reject_transaction_type import TakeProfitOrderRejectTransactionType
...
class TakeProfitOrderRejectTransaction:
    ...
    trigger_condition: Union[Unset, TakeProfitOrderRejectTransactionTriggerCondition] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TakeProfitOrderRejectTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = TakeProfitOrderRejectTransactionTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, TakeProfitOrderRejectTransactionTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = TakeProfitOrderRejectTransactionTriggerCondition(_trigger_condition)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = TakeProfitOrderRejectTransactionReason(_reason)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = TakeProfitOrderRejectTransactionRejectReason(_reject_reason)
