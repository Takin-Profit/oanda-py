...
from ..models.delayed_trade_closure_transaction_reason import DelayedTradeClosureTransactionReason
from ..models.delayed_trade_closure_transaction_type import DelayedTradeClosureTransactionType
...
class DelayedTradeClosureTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = DelayedTradeClosureTransactionType(_type)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = DelayedTradeClosureTransactionReason(_reason)
