...
from ..models.close_transaction_type import CloseTransactionType
...
class CloseTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, CloseTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = CloseTransactionType(_type)

        close_transaction = cls(
            id=id,
            time=time,
            user_id=user_id,
        ...
        close_transaction.additional_properties = d
