...
class OrderFillTransaction:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if gain_quote_home_conversion_factor is not UNSET:
            field_dict["gainQuoteHomeConversionFactor"] = gain_quote_home_conversion_factor
        if loss_quote_home_conversion_factor is not UNSET:
            field_dict["lossQuoteHomeConversionFactor"] = loss_quote_home_conversion_factor
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = OrderFillTransactionType(_type)
        ...
        gain_quote_home_conversion_factor = d.pop("gainQuoteHomeConversionFactor", UNSET)

        loss_quote_home_conversion_factor = d.pop("lossQuoteHomeConversionFactor", UNSET)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = OrderFillTransactionReason(_reason)
