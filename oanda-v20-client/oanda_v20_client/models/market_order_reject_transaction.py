...
from ..models.market_order_reject_transaction_position_fill import MarketOrderRejectTransactionPositionFill
from ..models.market_order_reject_transaction_reason import MarketOrderRejectTransactionReason
from ..models.market_order_reject_transaction_reject_reason import MarketOrderRejectTransactionRejectReason
from ..models.market_order_reject_transaction_time_in_force import MarketOrderRejectTransactionTimeInForce
from ..models.market_order_reject_transaction_type import MarketOrderRejectTransactionType
...
class MarketOrderRejectTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = MarketOrderRejectTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = MarketOrderRejectTransactionTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = MarketOrderRejectTransactionPositionFill(_position_fill)
        ...
        if isinstance(_long_position_closeout, Unset):
            ...
            long_position_closeout = MarketOrderPositionCloseout.from_dict(_long_position_closeout)
        ...
        if isinstance(_short_position_closeout, Unset):
            ...
            short_position_closeout = MarketOrderPositionCloseout.from_dict(_short_position_closeout)
        ...
        if isinstance(_delayed_trade_close, Unset):
            ...
            delayed_trade_close = MarketOrderDelayedTradeClose.from_dict(_delayed_trade_close)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = MarketOrderRejectTransactionReason(_reason)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = MarketOrderRejectTransactionRejectReason(_reject_reason)
