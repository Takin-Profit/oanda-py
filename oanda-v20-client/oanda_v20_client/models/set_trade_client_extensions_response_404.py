...
class SetTradeClientExtensionsResponse404:
    ...
    def to_dict(self) -> Dict[str, Any]:
        trade_client_extensions_modify_reject_transaction: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.trade_client_extensions_modify_reject_transaction, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_trade_client_extensions_modify_reject_transaction, Unset):
            ...
            trade_client_extensions_modify_reject_transaction = TradeClientExtensionsModifyRejectTransaction.from_dict(
