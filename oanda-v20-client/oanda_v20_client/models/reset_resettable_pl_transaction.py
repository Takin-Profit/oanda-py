...
from ..models.reset_resettable_pl_transaction_type import ResetResettablePLTransactionType
...
class ResetResettablePLTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, ResetResettablePLTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = ResetResettablePLTransactionType(_type)
