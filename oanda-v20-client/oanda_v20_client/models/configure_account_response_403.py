...
class ConfigureAccountResponse403:
    ...
    client_configure_reject_transaction: Union[Unset, "ClientConfigureRejectTransaction"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.client_configure_reject_transaction, Unset):
            client_configure_reject_transaction = self.client_configure_reject_transaction.to_dict()
        ...
        if client_configure_reject_transaction is not UNSET:
            field_dict["clientConfigureRejectTransaction"] = client_configure_reject_transaction
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _client_configure_reject_transaction = d.pop("clientConfigureRejectTransaction", UNSET)
        client_configure_reject_transaction: Union[Unset, ClientConfigureRejectTransaction]
        if isinstance(_client_configure_reject_transaction, Unset):
            client_configure_reject_transaction = UNSET
        else:
            client_configure_reject_transaction = ClientConfigureRejectTransaction.from_dict(
