...
class ReplaceOrderResponse201:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.order_reissue_reject_transaction, Unset):
            order_reissue_reject_transaction = self.order_reissue_reject_transaction.to_dict()
        ...
        if not isinstance(self.replacing_order_cancel_transaction, Unset):
            replacing_order_cancel_transaction = self.replacing_order_cancel_transaction.to_dict()
        ...
        if order_reissue_reject_transaction is not UNSET:
            field_dict["orderReissueRejectTransaction"] = order_reissue_reject_transaction
        if replacing_order_cancel_transaction is not UNSET:
            field_dict["replacingOrderCancelTransaction"] = replacing_order_cancel_transaction
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_order_cancel_transaction, Unset):
            ...
            order_cancel_transaction = OrderCancelTransaction.from_dict(_order_cancel_transaction)
        ...
        if isinstance(_order_fill_transaction, Unset):
            ...
            order_fill_transaction = OrderFillTransaction.from_dict(_order_fill_transaction)
        ...
        if isinstance(_order_reissue_transaction, Unset):
            ...
            order_reissue_transaction = Transaction.from_dict(_order_reissue_transaction)

        _order_reissue_reject_transaction = d.pop("orderReissueRejectTransaction", UNSET)
        ...
        if isinstance(_order_reissue_reject_transaction, Unset):
            ...
            order_reissue_reject_transaction = Transaction.from_dict(_order_reissue_reject_transaction)

        _replacing_order_cancel_transaction = d.pop("replacingOrderCancelTransaction", UNSET)
        ...
        if isinstance(_replacing_order_cancel_transaction, Unset):
            ...
            replacing_order_cancel_transaction = OrderCancelTransaction.from_dict(_replacing_order_cancel_transaction)
