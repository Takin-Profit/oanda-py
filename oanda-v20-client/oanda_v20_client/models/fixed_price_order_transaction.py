...
from ..models.fixed_price_order_transaction_position_fill import FixedPriceOrderTransactionPositionFill
from ..models.fixed_price_order_transaction_reason import FixedPriceOrderTransactionReason
...
class FixedPriceOrderTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = FixedPriceOrderTransactionType(_type)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = FixedPriceOrderTransactionPositionFill(_position_fill)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = FixedPriceOrderTransactionReason(_reason)
