...
class LimitOrder:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = LimitOrderTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = LimitOrderPositionFill(_position_fill)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = LimitOrderTriggerCondition(_trigger_condition)
