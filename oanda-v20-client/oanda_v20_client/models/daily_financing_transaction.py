...
from ..models.daily_financing_transaction_account_financing_mode import DailyFinancingTransactionAccountFinancingMode
...
class DailyFinancingTransaction:
    ...
    account_financing_mode: Union[Unset, DailyFinancingTransactionAccountFinancingMode] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.account_financing_mode, Unset):
            account_financing_mode = self.account_financing_mode.value
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = DailyFinancingTransactionType(_type)
        ...
        account_financing_mode: Union[Unset, DailyFinancingTransactionAccountFinancingMode]
        if isinstance(_account_financing_mode, Unset):
            account_financing_mode = UNSET
        else:
            account_financing_mode = DailyFinancingTransactionAccountFinancingMode(_account_financing_mode)

        position_financings = []
        _position_financings = d.pop("positionFinancings", UNSET)
        for position_financings_item_data in _position_financings or []:
            position_financings_item = PositionFinancing.from_dict(position_financings_item_data)
