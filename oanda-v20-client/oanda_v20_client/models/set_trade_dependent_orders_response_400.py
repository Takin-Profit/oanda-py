...
class SetTradeDependentOrdersResponse400:
    ...
    take_profit_order_cancel_reject_transaction: Union[Unset, "OrderCancelRejectTransaction"] = UNSET
    take_profit_order_reject_transaction: Union[Unset, "TakeProfitOrderRejectTransaction"] = UNSET
    stop_loss_order_cancel_reject_transaction: Union[Unset, "OrderCancelRejectTransaction"] = UNSET
    stop_loss_order_reject_transaction: Union[Unset, "StopLossOrderRejectTransaction"] = UNSET
    trailing_stop_loss_order_cancel_reject_transaction: Union[Unset, "OrderCancelRejectTransaction"] = UNSET
    trailing_stop_loss_order_reject_transaction: Union[Unset, "TrailingStopLossOrderRejectTransaction"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        take_profit_order_cancel_reject_transaction: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.take_profit_order_cancel_reject_transaction, Unset):
            take_profit_order_cancel_reject_transaction = self.take_profit_order_cancel_reject_transaction.to_dict()
        ...
        if not isinstance(self.take_profit_order_reject_transaction, Unset):
            take_profit_order_reject_transaction = self.take_profit_order_reject_transaction.to_dict()
        ...
        if not isinstance(self.stop_loss_order_cancel_reject_transaction, Unset):
            stop_loss_order_cancel_reject_transaction = self.stop_loss_order_cancel_reject_transaction.to_dict()
        ...
        if not isinstance(self.stop_loss_order_reject_transaction, Unset):
            stop_loss_order_reject_transaction = self.stop_loss_order_reject_transaction.to_dict()

        trailing_stop_loss_order_cancel_reject_transaction: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.trailing_stop_loss_order_cancel_reject_transaction, Unset):
            trailing_stop_loss_order_cancel_reject_transaction = (
                self.trailing_stop_loss_order_cancel_reject_transaction.to_dict()
            )

        trailing_stop_loss_order_reject_transaction: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.trailing_stop_loss_order_reject_transaction, Unset):
            trailing_stop_loss_order_reject_transaction = self.trailing_stop_loss_order_reject_transaction.to_dict()
        ...
        if take_profit_order_cancel_reject_transaction is not UNSET:
            field_dict["takeProfitOrderCancelRejectTransaction"] = take_profit_order_cancel_reject_transaction
        if take_profit_order_reject_transaction is not UNSET:
            field_dict["takeProfitOrderRejectTransaction"] = take_profit_order_reject_transaction
        if stop_loss_order_cancel_reject_transaction is not UNSET:
            field_dict["stopLossOrderCancelRejectTransaction"] = stop_loss_order_cancel_reject_transaction
        if stop_loss_order_reject_transaction is not UNSET:
            field_dict["stopLossOrderRejectTransaction"] = stop_loss_order_reject_transaction
        ...
        if trailing_stop_loss_order_reject_transaction is not UNSET:
            field_dict["trailingStopLossOrderRejectTransaction"] = trailing_stop_loss_order_reject_transaction
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _take_profit_order_cancel_reject_transaction = d.pop("takeProfitOrderCancelRejectTransaction", UNSET)
        take_profit_order_cancel_reject_transaction: Union[Unset, OrderCancelRejectTransaction]
        if isinstance(_take_profit_order_cancel_reject_transaction, Unset):
            take_profit_order_cancel_reject_transaction = UNSET
        else:
            take_profit_order_cancel_reject_transaction = OrderCancelRejectTransaction.from_dict(
                _take_profit_order_cancel_reject_transaction
            )

        _take_profit_order_reject_transaction = d.pop("takeProfitOrderRejectTransaction", UNSET)
        take_profit_order_reject_transaction: Union[Unset, TakeProfitOrderRejectTransaction]
        if isinstance(_take_profit_order_reject_transaction, Unset):
            take_profit_order_reject_transaction = UNSET
        else:
            take_profit_order_reject_transaction = TakeProfitOrderRejectTransaction.from_dict(
                _take_profit_order_reject_transaction
            )

        _stop_loss_order_cancel_reject_transaction = d.pop("stopLossOrderCancelRejectTransaction", UNSET)
        stop_loss_order_cancel_reject_transaction: Union[Unset, OrderCancelRejectTransaction]
        if isinstance(_stop_loss_order_cancel_reject_transaction, Unset):
            stop_loss_order_cancel_reject_transaction = UNSET
        else:
            stop_loss_order_cancel_reject_transaction = OrderCancelRejectTransaction.from_dict(
                _stop_loss_order_cancel_reject_transaction
            )

        _stop_loss_order_reject_transaction = d.pop("stopLossOrderRejectTransaction", UNSET)
        ...
        if isinstance(_stop_loss_order_reject_transaction, Unset):
            ...
            stop_loss_order_reject_transaction = StopLossOrderRejectTransaction.from_dict(
        ...
        trailing_stop_loss_order_cancel_reject_transaction: Union[Unset, OrderCancelRejectTransaction]
        if isinstance(_trailing_stop_loss_order_cancel_reject_transaction, Unset):
            ...
            trailing_stop_loss_order_cancel_reject_transaction = OrderCancelRejectTransaction.from_dict(
                _trailing_stop_loss_order_cancel_reject_transaction
            )

        _trailing_stop_loss_order_reject_transaction = d.pop("trailingStopLossOrderRejectTransaction", UNSET)
        trailing_stop_loss_order_reject_transaction: Union[Unset, TrailingStopLossOrderRejectTransaction]
        if isinstance(_trailing_stop_loss_order_reject_transaction, Unset):
            trailing_stop_loss_order_reject_transaction = UNSET
        else:
            trailing_stop_loss_order_reject_transaction = TrailingStopLossOrderRejectTransaction.from_dict(
