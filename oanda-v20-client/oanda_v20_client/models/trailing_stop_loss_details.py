...
from ..models.trailing_stop_loss_details_time_in_force import TrailingStopLossDetailsTimeInForce
...
class TrailingStopLossDetails:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = TrailingStopLossDetailsTimeInForce(_time_in_force)
