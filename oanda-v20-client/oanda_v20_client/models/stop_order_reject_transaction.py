...
from ..models.stop_order_reject_transaction_position_fill import StopOrderRejectTransactionPositionFill
from ..models.stop_order_reject_transaction_reason import StopOrderRejectTransactionReason
from ..models.stop_order_reject_transaction_reject_reason import StopOrderRejectTransactionRejectReason
from ..models.stop_order_reject_transaction_time_in_force import StopOrderRejectTransactionTimeInForce
from ..models.stop_order_reject_transaction_trigger_condition import StopOrderRejectTransactionTriggerCondition
from ..models.stop_order_reject_transaction_type import StopOrderRejectTransactionType
...
class StopOrderRejectTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, StopOrderRejectTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = StopOrderRejectTransactionType(_type)
        ...
        time_in_force: Union[Unset, StopOrderRejectTransactionTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = StopOrderRejectTransactionTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _position_fill = d.pop("positionFill", UNSET)
        position_fill: Union[Unset, StopOrderRejectTransactionPositionFill]
        if isinstance(_position_fill, Unset):
            position_fill = UNSET
        else:
            position_fill = StopOrderRejectTransactionPositionFill(_position_fill)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, StopOrderRejectTransactionTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = StopOrderRejectTransactionTriggerCondition(_trigger_condition)

        _reason = d.pop("reason", UNSET)
        reason: Union[Unset, StopOrderRejectTransactionReason]
        if isinstance(_reason, Unset):
            reason = UNSET
        else:
            reason = StopOrderRejectTransactionReason(_reason)
        ...
        reject_reason: Union[Unset, StopOrderRejectTransactionRejectReason]
        if isinstance(_reject_reason, Unset):
            reject_reason = UNSET
        else:
            reject_reason = StopOrderRejectTransactionRejectReason(_reject_reason)
