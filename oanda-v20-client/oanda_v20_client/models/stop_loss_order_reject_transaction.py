...
from ..models.stop_loss_order_reject_transaction_reason import StopLossOrderRejectTransactionReason
from ..models.stop_loss_order_reject_transaction_reject_reason import StopLossOrderRejectTransactionRejectReason
from ..models.stop_loss_order_reject_transaction_time_in_force import StopLossOrderRejectTransactionTimeInForce
from ..models.stop_loss_order_reject_transaction_trigger_condition import StopLossOrderRejectTransactionTriggerCondition
from ..models.stop_loss_order_reject_transaction_type import StopLossOrderRejectTransactionType
...
class StopLossOrderRejectTransaction:
    ...
    trigger_condition: Union[Unset, StopLossOrderRejectTransactionTriggerCondition] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = StopLossOrderRejectTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = StopLossOrderRejectTransactionTimeInForce(_time_in_force)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = StopLossOrderRejectTransactionTriggerCondition(_trigger_condition)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = StopLossOrderRejectTransactionReason(_reason)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = StopLossOrderRejectTransactionRejectReason(_reject_reason)
