...
class ClosePositionResponse400:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.short_order_reject_transaction, Unset):
            short_order_reject_transaction = self.short_order_reject_transaction.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_long_order_reject_transaction, Unset):
            ...
            long_order_reject_transaction = MarketOrderRejectTransaction.from_dict(_long_order_reject_transaction)
        ...
        if isinstance(_short_order_reject_transaction, Unset):
            ...
            short_order_reject_transaction = MarketOrderRejectTransaction.from_dict(_short_order_reject_transaction)
