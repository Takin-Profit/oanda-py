...
class SetOrderClientExtensionsResponse404:
    ...
    def to_dict(self) -> Dict[str, Any]:
        order_client_extensions_modify_reject_transaction: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.order_client_extensions_modify_reject_transaction, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_order_client_extensions_modify_reject_transaction, Unset):
            ...
            order_client_extensions_modify_reject_transaction = OrderClientExtensionsModifyRejectTransaction.from_dict(
