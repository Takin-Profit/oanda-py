...
from ..models.trailing_stop_loss_order_transaction_reason import TrailingStopLossOrderTransactionReason
from ..models.trailing_stop_loss_order_transaction_time_in_force import TrailingStopLossOrderTransactionTimeInForce
...
from ..models.trailing_stop_loss_order_transaction_type import TrailingStopLossOrderTransactionType
...
class TrailingStopLossOrderTransaction:
    ...
    trigger_condition: Union[Unset, TrailingStopLossOrderTransactionTriggerCondition] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TrailingStopLossOrderTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = TrailingStopLossOrderTransactionTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, TrailingStopLossOrderTransactionTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = TrailingStopLossOrderTransactionTriggerCondition(_trigger_condition)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = TrailingStopLossOrderTransactionReason(_reason)
