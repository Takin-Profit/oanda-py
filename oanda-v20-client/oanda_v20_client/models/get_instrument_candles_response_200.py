...
from ..models.get_instrument_candles_response_200_granularity import GetInstrumentCandlesResponse200Granularity
...
class GetInstrumentCandlesResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_granularity, Unset):
            ...
            granularity = GetInstrumentCandlesResponse200Granularity(_granularity)
