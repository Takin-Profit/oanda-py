...
from ..models.margin_call_exit_transaction_type import MarginCallExitTransactionType
...
class MarginCallExitTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, MarginCallExitTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = MarginCallExitTransactionType(_type)
