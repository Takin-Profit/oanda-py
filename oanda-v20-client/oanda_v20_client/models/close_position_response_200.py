...
class ClosePositionResponse200:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.short_order_create_transaction, Unset):
            short_order_create_transaction = self.short_order_create_transaction.to_dict()
        ...
        if not isinstance(self.short_order_cancel_transaction, Unset):
            short_order_cancel_transaction = self.short_order_cancel_transaction.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_long_order_create_transaction, Unset):
            ...
            long_order_create_transaction = MarketOrderTransaction.from_dict(_long_order_create_transaction)
        ...
        if isinstance(_long_order_fill_transaction, Unset):
            ...
            long_order_fill_transaction = OrderFillTransaction.from_dict(_long_order_fill_transaction)
        ...
        if isinstance(_long_order_cancel_transaction, Unset):
            ...
            long_order_cancel_transaction = OrderCancelTransaction.from_dict(_long_order_cancel_transaction)
        ...
        if isinstance(_short_order_create_transaction, Unset):
            ...
            short_order_create_transaction = MarketOrderTransaction.from_dict(_short_order_create_transaction)
        ...
        if isinstance(_short_order_fill_transaction, Unset):
            ...
            short_order_fill_transaction = OrderFillTransaction.from_dict(_short_order_fill_transaction)
        ...
        if isinstance(_short_order_cancel_transaction, Unset):
            ...
            short_order_cancel_transaction = OrderCancelTransaction.from_dict(_short_order_cancel_transaction)
