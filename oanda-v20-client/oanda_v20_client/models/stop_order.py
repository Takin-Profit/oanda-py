...
from ..models.stop_order_position_fill import StopOrderPositionFill
from ..models.stop_order_state import StopOrderState
from ..models.stop_order_time_in_force import StopOrderTimeInForce
from ..models.stop_order_trigger_condition import StopOrderTriggerCondition
from ..models.stop_order_type import StopOrderType
...
class StopOrder:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        state: Union[Unset, StopOrderState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = StopOrderState(_state)
        ...
        type: Union[Unset, StopOrderType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = StopOrderType(_type)
        ...
        time_in_force: Union[Unset, StopOrderTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = StopOrderTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _position_fill = d.pop("positionFill", UNSET)
        position_fill: Union[Unset, StopOrderPositionFill]
        if isinstance(_position_fill, Unset):
            position_fill = UNSET
        else:
            position_fill = StopOrderPositionFill(_position_fill)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, StopOrderTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = StopOrderTriggerCondition(_trigger_condition)
        ...
        stop_order.additional_properties = d
        return stop_order
