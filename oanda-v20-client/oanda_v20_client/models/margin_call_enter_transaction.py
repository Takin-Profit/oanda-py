...
from ..models.margin_call_enter_transaction_type import MarginCallEnterTransactionType
...
class MarginCallEnterTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, MarginCallEnterTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = MarginCallEnterTransactionType(_type)

        margin_call_enter_transaction = cls(
            id=id,
            time=time,
            user_id=user_id,
        ...
        margin_call_enter_transaction.additional_properties = d
        return margin_call_enter_transaction
