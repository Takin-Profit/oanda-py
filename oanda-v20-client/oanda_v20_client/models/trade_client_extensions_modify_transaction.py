...
from ..models.trade_client_extensions_modify_transaction_type import TradeClientExtensionsModifyTransactionType
...
class TradeClientExtensionsModifyTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TradeClientExtensionsModifyTransactionType(_type)
