...
class SetTradeDependentOrdersResponse200:
    ...
    take_profit_order_created_cancel_transaction: Union[Unset, "OrderCancelTransaction"] = UNSET
    ...
    stop_loss_order_created_cancel_transaction: Union[Unset, "OrderCancelTransaction"] = UNSET
    trailing_stop_loss_order_cancel_transaction: Union[Unset, "OrderCancelTransaction"] = UNSET
    trailing_stop_loss_order_transaction: Union[Unset, "TrailingStopLossOrderTransaction"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.take_profit_order_cancel_transaction, Unset):
            take_profit_order_cancel_transaction = self.take_profit_order_cancel_transaction.to_dict()
        ...
        if not isinstance(self.take_profit_order_fill_transaction, Unset):
            take_profit_order_fill_transaction = self.take_profit_order_fill_transaction.to_dict()

        take_profit_order_created_cancel_transaction: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.take_profit_order_created_cancel_transaction, Unset):
            take_profit_order_created_cancel_transaction = self.take_profit_order_created_cancel_transaction.to_dict()
        ...
        if not isinstance(self.stop_loss_order_cancel_transaction, Unset):
            stop_loss_order_cancel_transaction = self.stop_loss_order_cancel_transaction.to_dict()
        ...
        if not isinstance(self.stop_loss_order_fill_transaction, Unset):
            stop_loss_order_fill_transaction = self.stop_loss_order_fill_transaction.to_dict()
        ...
        if not isinstance(self.stop_loss_order_created_cancel_transaction, Unset):
            stop_loss_order_created_cancel_transaction = self.stop_loss_order_created_cancel_transaction.to_dict()

        trailing_stop_loss_order_cancel_transaction: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.trailing_stop_loss_order_cancel_transaction, Unset):
            trailing_stop_loss_order_cancel_transaction = self.trailing_stop_loss_order_cancel_transaction.to_dict()
        ...
        if not isinstance(self.trailing_stop_loss_order_transaction, Unset):
            trailing_stop_loss_order_transaction = self.trailing_stop_loss_order_transaction.to_dict()
        ...
        if take_profit_order_cancel_transaction is not UNSET:
            field_dict["takeProfitOrderCancelTransaction"] = take_profit_order_cancel_transaction
        ...
        if take_profit_order_fill_transaction is not UNSET:
            field_dict["takeProfitOrderFillTransaction"] = take_profit_order_fill_transaction
        if take_profit_order_created_cancel_transaction is not UNSET:
            field_dict["takeProfitOrderCreatedCancelTransaction"] = take_profit_order_created_cancel_transaction
        if stop_loss_order_cancel_transaction is not UNSET:
            field_dict["stopLossOrderCancelTransaction"] = stop_loss_order_cancel_transaction
        ...
        if stop_loss_order_fill_transaction is not UNSET:
            field_dict["stopLossOrderFillTransaction"] = stop_loss_order_fill_transaction
        if stop_loss_order_created_cancel_transaction is not UNSET:
            field_dict["stopLossOrderCreatedCancelTransaction"] = stop_loss_order_created_cancel_transaction
        if trailing_stop_loss_order_cancel_transaction is not UNSET:
            field_dict["trailingStopLossOrderCancelTransaction"] = trailing_stop_loss_order_cancel_transaction
        if trailing_stop_loss_order_transaction is not UNSET:
            field_dict["trailingStopLossOrderTransaction"] = trailing_stop_loss_order_transaction
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _take_profit_order_cancel_transaction = d.pop("takeProfitOrderCancelTransaction", UNSET)
        ...
        if isinstance(_take_profit_order_transaction, Unset):
            ...
            take_profit_order_transaction = TakeProfitOrderTransaction.from_dict(_take_profit_order_transaction)

        _take_profit_order_fill_transaction = d.pop("takeProfitOrderFillTransaction", UNSET)
        ...
        if isinstance(_take_profit_order_fill_transaction, Unset):
            ...
            take_profit_order_fill_transaction = OrderFillTransaction.from_dict(_take_profit_order_fill_transaction)

        _take_profit_order_created_cancel_transaction = d.pop("takeProfitOrderCreatedCancelTransaction", UNSET)
        take_profit_order_created_cancel_transaction: Union[Unset, OrderCancelTransaction]
        if isinstance(_take_profit_order_created_cancel_transaction, Unset):
            take_profit_order_created_cancel_transaction = UNSET
        else:
            take_profit_order_created_cancel_transaction = OrderCancelTransaction.from_dict(
                _take_profit_order_created_cancel_transaction
            )

        _stop_loss_order_cancel_transaction = d.pop("stopLossOrderCancelTransaction", UNSET)
        ...
        if isinstance(_stop_loss_order_cancel_transaction, Unset):
            ...
            stop_loss_order_cancel_transaction = OrderCancelTransaction.from_dict(_stop_loss_order_cancel_transaction)
        ...
        if isinstance(_stop_loss_order_transaction, Unset):
            ...
            stop_loss_order_transaction = StopLossOrderTransaction.from_dict(_stop_loss_order_transaction)
        ...
        if isinstance(_stop_loss_order_fill_transaction, Unset):
            ...
            stop_loss_order_fill_transaction = OrderFillTransaction.from_dict(_stop_loss_order_fill_transaction)

        _stop_loss_order_created_cancel_transaction = d.pop("stopLossOrderCreatedCancelTransaction", UNSET)
        ...
        if isinstance(_stop_loss_order_created_cancel_transaction, Unset):
            ...
            stop_loss_order_created_cancel_transaction = OrderCancelTransaction.from_dict(
                _stop_loss_order_created_cancel_transaction
            )

        _trailing_stop_loss_order_cancel_transaction = d.pop("trailingStopLossOrderCancelTransaction", UNSET)
        trailing_stop_loss_order_cancel_transaction: Union[Unset, OrderCancelTransaction]
        if isinstance(_trailing_stop_loss_order_cancel_transaction, Unset):
            trailing_stop_loss_order_cancel_transaction = UNSET
        else:
            trailing_stop_loss_order_cancel_transaction = OrderCancelTransaction.from_dict(
                _trailing_stop_loss_order_cancel_transaction
            )

        _trailing_stop_loss_order_transaction = d.pop("trailingStopLossOrderTransaction", UNSET)
        trailing_stop_loss_order_transaction: Union[Unset, TrailingStopLossOrderTransaction]
        if isinstance(_trailing_stop_loss_order_transaction, Unset):
            trailing_stop_loss_order_transaction = UNSET
        else:
            trailing_stop_loss_order_transaction = TrailingStopLossOrderTransaction.from_dict(
