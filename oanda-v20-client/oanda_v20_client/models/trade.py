...
class Trade:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        closing_transaction_i_ds = cast(List[str], d.pop("closingTransactionIDs", UNSET))
        ...
        if isinstance(_trailing_stop_loss_order, Unset):
            ...
            trailing_stop_loss_order = TrailingStopLossOrder.from_dict(_trailing_stop_loss_order)
