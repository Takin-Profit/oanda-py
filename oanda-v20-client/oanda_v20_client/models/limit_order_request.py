...
from ..models.limit_order_request_trigger_condition import LimitOrderRequestTriggerCondition
...
class LimitOrderRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = LimitOrderRequestType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = LimitOrderRequestTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = LimitOrderRequestPositionFill(_position_fill)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = LimitOrderRequestTriggerCondition(_trigger_condition)
