...
from ..models.transfer_funds_reject_transaction_funding_reason import TransferFundsRejectTransactionFundingReason
from ..models.transfer_funds_reject_transaction_reject_reason import TransferFundsRejectTransactionRejectReason
from ..models.transfer_funds_reject_transaction_type import TransferFundsRejectTransactionType
...
class TransferFundsRejectTransaction:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.funding_reason, Unset):
            funding_reason = self.funding_reason.value
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TransferFundsRejectTransactionType(_type)
        ...
        if isinstance(_funding_reason, Unset):
            ...
            funding_reason = TransferFundsRejectTransactionFundingReason(_funding_reason)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = TransferFundsRejectTransactionRejectReason(_reject_reason)
