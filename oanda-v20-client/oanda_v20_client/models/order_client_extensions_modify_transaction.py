...
from ..models.order_client_extensions_modify_transaction_type import OrderClientExtensionsModifyTransactionType
...
class OrderClientExtensionsModifyTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, OrderClientExtensionsModifyTransactionType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = OrderClientExtensionsModifyTransactionType(_type)
        ...
        order_client_extensions_modify_transaction.additional_properties = d
