...
from ..models.order_cancel_reject_transaction_reject_reason import OrderCancelRejectTransactionRejectReason
from ..models.order_cancel_reject_transaction_type import OrderCancelRejectTransactionType
...
class OrderCancelRejectTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = OrderCancelRejectTransactionType(_type)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = OrderCancelRejectTransactionRejectReason(_reject_reason)
