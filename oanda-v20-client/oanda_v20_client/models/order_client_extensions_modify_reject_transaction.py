...
class OrderClientExtensionsModifyRejectTransaction:
    ...
    reject_reason: Union[Unset, OrderClientExtensionsModifyRejectTransactionRejectReason] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = OrderClientExtensionsModifyRejectTransactionType(_type)
        ...
        if isinstance(_client_extensions_modify, Unset):
            ...
            client_extensions_modify = ClientExtensions.from_dict(_client_extensions_modify)
        ...
        reject_reason: Union[Unset, OrderClientExtensionsModifyRejectTransactionRejectReason]
        if isinstance(_reject_reason, Unset):
            reject_reason = UNSET
        else:
            reject_reason = OrderClientExtensionsModifyRejectTransactionRejectReason(_reject_reason)
