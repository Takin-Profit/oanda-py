...
from ..models.market_if_touched_order_position_fill import MarketIfTouchedOrderPositionFill
from ..models.market_if_touched_order_state import MarketIfTouchedOrderState
from ..models.market_if_touched_order_time_in_force import MarketIfTouchedOrderTimeInForce
from ..models.market_if_touched_order_trigger_condition import MarketIfTouchedOrderTriggerCondition
from ..models.market_if_touched_order_type import MarketIfTouchedOrderType
...
class MarketIfTouchedOrder:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if initial_market_price is not UNSET:
            field_dict["initialMarketPrice"] = initial_market_price
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        state: Union[Unset, MarketIfTouchedOrderState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = MarketIfTouchedOrderState(_state)
        ...
        type: Union[Unset, MarketIfTouchedOrderType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = MarketIfTouchedOrderType(_type)
        ...
        time_in_force: Union[Unset, MarketIfTouchedOrderTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = MarketIfTouchedOrderTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _position_fill = d.pop("positionFill", UNSET)
        position_fill: Union[Unset, MarketIfTouchedOrderPositionFill]
        if isinstance(_position_fill, Unset):
            position_fill = UNSET
        else:
            position_fill = MarketIfTouchedOrderPositionFill(_position_fill)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, MarketIfTouchedOrderTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = MarketIfTouchedOrderTriggerCondition(_trigger_condition)

        initial_market_price = d.pop("initialMarketPrice", UNSET)
