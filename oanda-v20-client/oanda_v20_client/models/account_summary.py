...
from ..models.account_summary_guaranteed_stop_loss_order_mode import AccountSummaryGuaranteedStopLossOrderMode
...
class AccountSummary:
    ...
    guaranteed_stop_loss_order_mode: Union[Unset, AccountSummaryGuaranteedStopLossOrderMode] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.guaranteed_stop_loss_order_mode, Unset):
            guaranteed_stop_loss_order_mode = self.guaranteed_stop_loss_order_mode.value
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        guaranteed_stop_loss_order_mode: Union[Unset, AccountSummaryGuaranteedStopLossOrderMode]
        if isinstance(_guaranteed_stop_loss_order_mode, Unset):
            guaranteed_stop_loss_order_mode = UNSET
        else:
            guaranteed_stop_loss_order_mode = AccountSummaryGuaranteedStopLossOrderMode(
