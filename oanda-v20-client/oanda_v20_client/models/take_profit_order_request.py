...
from ..models.take_profit_order_request_time_in_force import TakeProfitOrderRequestTimeInForce
from ..models.take_profit_order_request_trigger_condition import TakeProfitOrderRequestTriggerCondition
...
class TakeProfitOrderRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TakeProfitOrderRequestType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = TakeProfitOrderRequestTimeInForce(_time_in_force)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = TakeProfitOrderRequestTriggerCondition(_trigger_condition)
