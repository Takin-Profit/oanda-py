...
class MarketOrder:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = MarketOrderTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = MarketOrderPositionFill(_position_fill)
