...
from ..models.trailing_stop_loss_order_request_time_in_force import TrailingStopLossOrderRequestTimeInForce
from ..models.trailing_stop_loss_order_request_trigger_condition import TrailingStopLossOrderRequestTriggerCondition
from ..models.trailing_stop_loss_order_request_type import TrailingStopLossOrderRequestType
...
class TrailingStopLossOrderRequest:
    ...
    trigger_condition: Union[Unset, TrailingStopLossOrderRequestTriggerCondition] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TrailingStopLossOrderRequestType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = TrailingStopLossOrderRequestTimeInForce(_time_in_force)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = TrailingStopLossOrderRequestTriggerCondition(_trigger_condition)
