...
from ..models.limit_order_reject_transaction_position_fill import LimitOrderRejectTransactionPositionFill
from ..models.limit_order_reject_transaction_reason import LimitOrderRejectTransactionReason
from ..models.limit_order_reject_transaction_reject_reason import LimitOrderRejectTransactionRejectReason
from ..models.limit_order_reject_transaction_time_in_force import LimitOrderRejectTransactionTimeInForce
from ..models.limit_order_reject_transaction_trigger_condition import LimitOrderRejectTransactionTriggerCondition
...
class LimitOrderRejectTransaction:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = LimitOrderRejectTransactionType(_type)
        ...
        if isinstance(_time_in_force, Unset):
            ...
            time_in_force = LimitOrderRejectTransactionTimeInForce(_time_in_force)
        ...
        if isinstance(_position_fill, Unset):
            ...
            position_fill = LimitOrderRejectTransactionPositionFill(_position_fill)
        ...
        if isinstance(_trigger_condition, Unset):
            ...
            trigger_condition = LimitOrderRejectTransactionTriggerCondition(_trigger_condition)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = LimitOrderRejectTransactionReason(_reason)
        ...
        if isinstance(_reject_reason, Unset):
            ...
            reject_reason = LimitOrderRejectTransactionRejectReason(_reject_reason)
