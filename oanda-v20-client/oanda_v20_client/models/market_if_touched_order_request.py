...
from ..models.market_if_touched_order_request_position_fill import MarketIfTouchedOrderRequestPositionFill
from ..models.market_if_touched_order_request_time_in_force import MarketIfTouchedOrderRequestTimeInForce
from ..models.market_if_touched_order_request_trigger_condition import MarketIfTouchedOrderRequestTriggerCondition
from ..models.market_if_touched_order_request_type import MarketIfTouchedOrderRequestType
...
class MarketIfTouchedOrderRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, MarketIfTouchedOrderRequestType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = MarketIfTouchedOrderRequestType(_type)
        ...
        time_in_force: Union[Unset, MarketIfTouchedOrderRequestTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = MarketIfTouchedOrderRequestTimeInForce(_time_in_force)

        gtd_time = d.pop("gtdTime", UNSET)

        _position_fill = d.pop("positionFill", UNSET)
        position_fill: Union[Unset, MarketIfTouchedOrderRequestPositionFill]
        if isinstance(_position_fill, Unset):
            position_fill = UNSET
        else:
            position_fill = MarketIfTouchedOrderRequestPositionFill(_position_fill)

        _trigger_condition = d.pop("triggerCondition", UNSET)
        trigger_condition: Union[Unset, MarketIfTouchedOrderRequestTriggerCondition]
        if isinstance(_trigger_condition, Unset):
            trigger_condition = UNSET
        else:
            trigger_condition = MarketIfTouchedOrderRequestTriggerCondition(_trigger_condition)
