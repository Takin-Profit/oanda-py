...
from ...models.list_trades_response_200 import ListTradesResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/accounts/{account_id}/trades",
        "params": params,
    }
...
) -> Optional[Union[Any, ListTradesResponse200]]:
    if response.status_code == 200:
        response_200 = ListTradesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ListTradesResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ListTradesResponse200]
    """
