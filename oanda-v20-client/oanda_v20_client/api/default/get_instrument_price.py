...
from ...models.get_instrument_price_response_200 import GetInstrumentPriceResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/instruments/{instrument}/price",
        "params": params,
    }
...
) -> Optional[Union[Any, GetInstrumentPriceResponse200]]:
    if response.status_code == 200:
        response_200 = GetInstrumentPriceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetInstrumentPriceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, GetInstrumentPriceResponse200]
    """
