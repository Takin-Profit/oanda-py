...
from ...models.get_instruments_instrument_order_book_response_200 import GetInstrumentsInstrumentOrderBookResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/instruments/{instrument}/orderBook",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetInstrumentsInstrumentOrderBookResponse200.from_dict(response.json())
